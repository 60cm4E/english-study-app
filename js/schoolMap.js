...
const SCHOOL_MAP = {
  chilbo:    { name: '칠보중', emoji: '🏫', examType: 'writing', grades: { 1: 'donga-yoon-22', 2: 'donga-yoon-22', 3: 'donga-lee-15' }},
  homae:     { name: '호매실중', emoji: '🎓', examType: 'mixed', grades: { 1: 'ybm-park-22', 2: 'ybm-park-22', 3: 'donga-yoon-15' }},
  neungsil:  { name: '능실중', emoji: '📖', examType: 'mixed', grades: { 1: 'donga-yoon-22', 2: 'donga-yoon-22', 3: 'neungyul-kim-15' }},
  sangchon:  { name: '상촌중', emoji: '✏️', examType: 'mixed', grades: { 1: 'donga-yoon-22', 2: 'donga-yoon-22', 3: 'donga-yoon-15' }}
};
